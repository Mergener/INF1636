...
class World {
	...
	public static World generateDefaultWorld() {
		...
		Territory alaska = new Territory("Alaska", new Point(82f/1024, 130f/768), new Point[] { new Point(0.083008f, 0.154948f), new Point(0.070312f, 0.178385f), new Point(0.056641f, 0.210938f), new Point(0.108398f, 0.210938f), new Point(0.129883f, 0.154948f) });
		...
		Territory algeria = new Territory("Algeria", new Point(463f/1024, 375f/768), new Point[] { new Point(0.425781f, 0.432292f), new Point(0.460938f, 0.432292f), new Point(0.467773f, 0.449219f), new Point(0.480469f, 0.449219f), new Point(0.487305f, 0.467448f), new Point(0.526367f, 0.467448f), new Point(0.500000f, 0.527344f), new Point(0.415039f, 0.527344f), new Point(0.399414f, 0.494792f) });
		Territory egypt = new Territory("Egypt", new Point(565f/1024, 390f/768), new Point[] { new Point(0.500977f, 0.527344f), new Point(0.534180f, 0.527344f), new Point(0.548828f, 0.561198f), new Point(0.607422f, 0.561198f), new Point(0.579102f, 0.494792f), new Point(0.583008f, 0.485677f), new Point(0.574219f, 0.462240f), new Point(0.529297f, 0.462240f) });
		...
		Territory southAfrica = new Territory("South Africa", new Point(577f/1024, 568f/768), new Point[] { new Point(0.515625f, 0.704427f), new Point(0.543945f, 0.774740f), new Point(0.583008f, 0.774740f), new Point(0.590820f, 0.755208f), new Point(0.598633f, 0.753906f), new Point(0.611328f, 0.721354f), new Point(0.602539f, 0.704427f) });		
		...
		Territory latvia = new Territory("Latvia", new Point(659f/1024, 192f/768), new Point[] { new Point(0.595703f, 0.182292f), new Point(0.577148f, 0.221354f), new Point(0.569336f, 0.222656f), new Point(0.595703f, 0.285156f), new Point(0.708008f, 0.283854f), new Point(0.720703f, 0.255208f), new Point(0.708008f, 0.220052f), new Point(0.610352f, 0.218750f) });
		Territory turkey = new Territory("Turkey", new Point(713f/1024, 248f/768), new Point[] { new Point(0.598633f, 0.285156f), new Point(0.752930f, 0.285156f), new Point(0.764648f, 0.313802f), new Point(0.746094f, 0.355469f), new Point(0.666992f, 0.355469f), new Point(0.673828f, 0.343750f), new Point(0.662109f, 0.315104f), new Point(0.651367f, 0.315104f), new Point(0.648438f, 0.307292f), new Point(0.635742f, 0.305990f), new Point(0.630859f, 0.320312f), new Point(0.624023f, 0.304688f), new Point(0.605469f, 0.304688f) });
		...
		Territory kazakhstan = new Territory("Kazakhstan", new Point(825f/1024, 219f/768), new Point[] { new Point(0.720703f, 0.256510f), new Point(0.707031f, 0.283854f), new Point(0.753906f, 0.285156f), new Point(0.764648f, 0.313802f), new Point(0.883789f, 0.313802f), new Point(0.897461f, 0.282552f), new Point(0.885742f, 0.255208f) });
		...
		Territory northKorea = new Territory("North Korea", new Point(862f/1024, 308f/768), new Point[] { new Point(0.818359f, 0.386719f), new Point(0.867188f, 0.386719f), new Point(0.872070f, 0.401042f), new Point(0.886719f, 0.402344f), new Point(0.891602f, 0.416667f), new Point(0.805664f, 0.417969f) });
		Territory southKorea = new Territory("South Korea", new Point(866f/1024, 333f/768), new Point[] { new Point(0.805664f, 0.417969f), new Point(0.791992f, 0.447917f), new Point(0.893555f, 0.449219f), new Point(0.900391f, 0.432292f), new Point(0.892578f, 0.417969f) });
		Territory japan = new Territory("Japan", new Point(949f/1024, 274f/768), new Point[] { new Point(0.915039f, 0.283854f), new Point(0.933594f, 0.324219f), new Point(0.930664f, 0.329427f), new Point(0.941406f, 0.352865f), new Point(0.931641f, 0.375000f), new Point(0.923828f, 0.375000f), new Point(0.916992f, 0.393229f), new Point(0.899414f, 0.393229f), new Point(0.908203f, 0.375000f), new Point(0.905273f, 0.368490f), new Point(0.911133f, 0.356771f), new Point(0.916016f, 0.360677f), new Point(0.920898f, 0.343750f), new Point(0.905273f, 0.304688f) });
		Territory syria = new Territory("Syria", new Point(667f/1024, 289f/768), new Point[] { new Point(0.700195f, 0.356771f), new Point(0.691406f, 0.378906f), new Point(0.699219f, 0.397135f), new Point(0.621094f, 0.397135f), new Point(0.621094f, 0.391927f), new Point(0.612305f, 0.390625f), new Point(0.604492f, 0.373698f), new Point(0.613281f, 0.351562f), new Point(0.630859f, 0.352865f), new Point(0.630859f, 0.347656f), new Point(0.644531f, 0.347656f), new Point(0.648438f, 0.356771f) });
		Territory iraq = new Territory("Iraq", new Point(673f/1024, 374f/768), new Point[] { new Point(0.637695f, 0.440104f), new Point(0.664062f, 0.497396f), new Point(0.689453f, 0.497396f), new Point(0.676758f, 0.466146f), new Point(0.685547f, 0.449219f), new Point(0.673828f, 0.421875f), new Point(0.683594f, 0.397135f), new Point(0.655273f, 0.397135f) });
		...
		Territory saudiArabia = new Territory("Saudi Arabia", new Point(671f/1024, 400f/768), new Point[] { new Point(0.637695f, 0.441406f), new Point(0.664062f, 0.498698f), new Point(0.699219f, 0.497396f), new Point(0.708984f, 0.518229f), new Point(0.682617f, 0.579427f), new Point(0.632812f, 0.579427f), new Point(0.624023f, 0.559896f), new Point(0.630859f, 0.545573f), new Point(0.612305f, 0.498698f) });		
		...
		Territory iran = new Territory("Iran", new Point(717f/1024, 342f/768), new Point[] { new Point(0.683594f, 0.398438f), new Point(0.699219f, 0.398438f), new Point(0.673828f, 0.421875f), new Point(0.699219f, 0.483073f), new Point(0.715820f, 0.483073f), new Point(0.722656f, 0.497396f), new Point(0.732422f, 0.475260f) });
		Territory pakistan = new Territory("Pakistan", new Point(748f/1024, 326f/768), new Point[] { new Point(0.700195f, 0.355469f), new Point(0.745117f, 0.355469f), new Point(0.736328f, 0.380208f), new Point(0.766602f, 0.449219f), new Point(0.745117f, 0.497396f), new Point(0.722656f, 0.497396f), new Point(0.732422f, 0.475260f), new Point(0.691406f, 0.380208f) });
	...
	public Territory findTerritory(String name) {
		...
		System.out.printf("Find territory returned null for %s\n", name);
		return null;
	}
